...
- **ลบ**: ลบค่าที่ตั้งไว้ล่วงหน้าปัจจุบัน การทำเช่นนี้จะทำให้การซิงค์ครั้งต่อไปของคุณเป็น [การซิงค์ทางเดียว](./syncing.md#conflicts)
...
Anki รวมการ์ดเรียนรู้ใดๆ ที่ [ข้ามขอบเขตของวัน](./preferences.md#scheduler) (การ์ดเรียนรู้ระหว่างวัน) ไว้ในจำนวนการทบทวน ดังนั้นการ์ดเรียนรู้เหล่านั้นจะอยู่ภายใต้ขีดจำกัดการทบทวน
...
ตัวเลือกที่นี่มีผลกับการ์ดใหม่และ [การ์ดเรียนรู้](getting-started.md#card-states) เท่านั้น เมื่อการ์ดสำเร็จการศึกษา (นั่นคือ ผ่านขั้นตอนการเรียนรู้ทั้งหมดแล้ว) ตัวเลือกในส่วนนี้จะไม่มีผลกับการ์ดอีกต่อไป
...
หากไม่มีอะไรให้เรียนอีก Anki จะแสดงการ์ดเรียนรู้ล่วงหน้าสูงสุด 20 นาทีโดยค่าเริ่มต้น หากต้องการปิดหรือเปลี่ยนระยะเวลาที่จะมองไปข้างหน้า โปรดดู [การตั้งค่า](preferences.md)

#### ขอบเขตของวัน

Anki ปฏิบัติต่อขั้นตอนเล็กๆ และขั้นตอนที่ [ข้ามขอบเขตของวัน](./preferences.md#review) แตกต่างกัน
...
จำนวนวันที่จะรอก่อนที่จะแสดงการ์ดอีกครั้ง หลังจากใช้ปุ่ม ดี ในขั้นตอนการเรียนรู้สุดท้าย ซึ่งหมายความว่านี่คือช่วงเวลาแรกหลังจากที่การ์ดเรียนรู้สำเร็จการศึกษา โปรดดูตัวอย่างจาก [ก่อนหน้านี้ในส่วนนี้](deck-options.md#learning-steps)
...
ควบคุมวิธีที่ Anki จัดการกับปลิง สำหรับรายละเอียด โปรดดูส่วน [ปลิง](leeches.md)
...
- **สำรับ**: รวบรวมการ์ดจากแต่ละสำรับย่อยตามลำดับ เริ่มจากด้านบน การ์ดจากแต่ละสำรับย่อยจะถูกรวบรวมในตำแหน่งจากน้อยไปมาก หากถึงขีดจำกัดรายวันของสำรับที่เลือก การรวบรวมอาจหยุดก่อนที่จะตรวจสอบสำรับย่อยทั้งหมด ลำดับนี้เร็วที่สุดในคอลเล็กชันขนาดใหญ่ และช่วยให้คุณจัดลำดับความสำคัญของสำรับย่อยที่อยู่ใกล้ด้านบนได้
  ...
  แม้ว่าลำดับตำแหน่งจะขึ้นอยู่กับตัวเลือกลำดับการแทรกในตอนแรก แต่คุณสามารถ [จัดตำแหน่งใหม่](./browsing.md#cards) การ์ดด้วยตนเองได้หลายวิธี
...
- **ข้ามคำถามเมื่อเล่นคำตอบซ้ำ**: ควบคุมว่าเสียงจากด้านคำถามจะเล่นหรือไม่เมื่อคุณใช้การกระทำเล่นซ้ำในด้านคำตอบ โปรดทราบว่า Anki [ไม่เล่นเสียงโดยอัตโนมัติ](./templates/fields.md#special-fields) จากฟิลด์ `{{FrontSide}}` ตัวเลือกนี้ไม่มีผลต่อพฤติกรรมการเล่นอัตโนมัติ
...
โดยค่าเริ่มต้น พารามิเตอร์จะคำนวณจากประวัติการทบทวนของสำรับทั้งหมดที่ใช้ค่าที่ตั้งไว้ล่วงหน้าปัจจุบัน คุณสามารถ [ปรับการค้นหา](./searching.md) ก่อนที่จะปรับพารามิเตอร์ให้เหมาะสมได้ หากคุณต้องการเปลี่ยนการ์ดที่ใช้สำหรับการปรับให้เหมาะสม
...
โดยค่าเริ่มต้น log loss และ RMSE (bins) จะคำนวณจากสำรับทั้งหมดที่ใช้ค่าที่ตั้งไว้ล่วงหน้าปัจจุบัน คุณสามารถ [ปรับการค้นหา](./searching.md) ก่อนที่จะประเมินพารามิเตอร์ได้ หากคุณต้องการเปลี่ยนการ์ดที่ใช้สำหรับการประเมิน
